...
@app.route('/')
def home():
    return "I'am Orion File Host - Running on Railway"
...
# Environment variables se sab kuch lo
TOKEN = os.environ.get('TELEGRAM_BOT_TOKEN', '')
OWNER_ID = int(os.environ.get('OWNER_ID', '1624840921'))
ADMIN_ID = int(os.environ.get('ADMIN_ID', str(OWNER_ID)))
YOUR_USERNAME = os.environ.get('YOUR_USERNAME', '@orion_store_07')
UPDATE_CHANNEL = os.environ.get('UPDATE_CHANNEL', 'https://t.me/+orionpvtgroup')

# Railway pe paths set karo
BASE_DIR = os.path.abspath(os.path.dirname(__file__))
# Railway pe /tmp use karo for temporary files
UPLOAD_BOTS_DIR = os.environ.get('UPLOAD_DIR', os.path.join(BASE_DIR, 'upload_bots'))
IROTECH_DIR = os.environ.get('DATA_DIR', os.path.join(BASE_DIR, 'inf'))
...
if not TOKEN:
    ...
    print("Railway pe Environment Variables set karo:")
    print("1. TELEGRAM_BOT_TOKEN = your_bot_token")
